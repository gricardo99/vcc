quote:([]time:`timespan$();sym:`g#`symbol$();exch:`$();bpx:`float$();apx:`float$();bsz:`float$();asz:`float$();bprcs:();aprcs:();bszs:();aszs:();bnm:();anm:();exchtm:`timestamp$();timestamp:`timestamp$());
trade:([]time:`timespan$();sym:`g#`symbol$();exch:`$();price:`float$();size:`float$();side:`$();exchtm:`timestamp$();timestamp:`timestamp$());
...
tidecalc:([]time:`timespan$();sym:`$();exchp:`$();buypct:`float$();buysz:`float$();sellpct:`float$();sellsz:`float$();timestamp:`timestamp$());
